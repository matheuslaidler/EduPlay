class DiscoverGame {
    constructor() {
        ...
        this.meltedPieces = 0;
        this.requiredMeltPercentage = 0.85; // 85% da imagem deve ser revelada para avançar
    ...
    handleMeltedPiece() {
        ...
        // Verificar se suficiente da imagem foi revelada
        const percentComplete = this.meltedPieces / this.totalIcePieces;
        if (percentComplete >= this.requiredMeltPercentage && !this.feedbackShown) {
            this.feedbackShown = true;
            this.nextLevelButton.disabled = false;
            
            // Parar a animação do personagem se estiver ativa
            this.stopCharacterAnimation();
    ...
    showCompletionEffect() {
        // Criar um elemento de celebração
        ...
        // Adicionar o estilo de animação
